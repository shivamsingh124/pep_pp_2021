    ...
    return new Promise (function(scb,fcb){
        ...
        waitpromise.then(function(){
            ...
            .then (function(){
             ...
             .then(function(){
                return tab.type('.public-DraftStyleDefault-block.public-DraftStyleDefault-ltr','Hi folks,SHIVAM here from covichat team .If you are willing to donate equipment then please become a member of our TEAM   :https://60b323e65fa6c4214725377d--hungry-ramanujan-95c835.netlify.app/');                //messgage
            })
            .then (function(){
                return tab.waitForTimeout(3000)
            })
            ...
            .then(function(){
                return waitandclick('a[href="/explore"] .css-1dbjc4n.r-1awozwy.r-sdzlij.r-18u37iz.r-1777fci.r-dnmrzs.r-xyw6el.r-o7ynqc.r-6416eg',{visible:true})      // ip kit            //input box
