...
(async function () {
    ...
    tab = pages[0];
    await tab.goto("https://twitter.com/search?q=%23covid%20%23need&src=typed_query&f=live");
    ...
    let jsonData1 = JSON.parse(fs.readFileSync("./need.json"));
    ...
    fs.writeFileSync("./need.json", JSON.stringify(jsonData1));
     await tab.close();
})();